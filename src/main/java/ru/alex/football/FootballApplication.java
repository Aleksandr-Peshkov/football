        ...
        while (!(ch.equals("`")) && !(ch.equals("ё")))
        {
            ...
            switch (ch)
            {
                ...
                case ("4"):
                    ...
                    break;
                case ("5"):
                    if(add_stadium()) print("успех");
                    break;
                case ("6"):
                    if(add_team()) print("успех");
                    break;
                case ("7"):
                    if(add_player()) print("успех");
                    break;
                case ("8"):
                    if(add_match()) print("успех");
                    break;
                case ("9"):
                    if(add_team_match()) print("успех");
                    break;
                case ("10"):
                    if(add_goal()) print("успех");
                    break;
                case ("11"):
                    System.out.println("С макарошками?");
                    break;
                case ("12"):
                    System.out.println("Нет, с пюрешкой");
                    break;
                case ("13"):
                    System.out.println("С пюрешкой?");
                    break;
                case ("14"):
                    System.out.println("С пюрешкой!");
                    break;
